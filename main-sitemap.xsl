			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - highvoltage</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - highvoltage</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://github.com/macpherson2025/highvoltagedenver.git/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
